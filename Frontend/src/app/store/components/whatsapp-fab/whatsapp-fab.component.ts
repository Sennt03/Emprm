...
@Component({
  ...
  styles: `
    ...
    .wfab {
      ...
      background: #25d366;
      color: #fff;
      box-shadow: 0 10px 26px rgb(37 211 102 / 42%), 0 4px 12px rgb(0 0 0 / 22%);
      transition: transform 0.2s ease, box-shadow 0.2s ease;
    }
    .wfab:hover { transform: scale(1.07); box-shadow: 0 14px 32px rgb(37 211 102 / 52%), 0 6px 16px rgb(0 0 0 / 26%); }
...
export class WhatsappFabComponent {
  private readonly message = '¡Hola EMPRM! 👋 Me gustaría más información sobre sus productos.';
  readonly href = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(this.message)}`;
}
