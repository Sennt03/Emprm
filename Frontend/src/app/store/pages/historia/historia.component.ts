  ...
  template: `
    ...
    <section class="intro">
      <div class="intro__inner" appReveal>
        <p>
          EMPRM nació en 2005 con una visión clara: ofrecer al hombre moderno prendas que combinen
...
export class HistoriaComponent {
  ...
  readonly milestones: Milestone[] = [
    { year: '2005', icon: '🚀', title: 'Fundación', text: 'Nace EMPRM con la visión de revolucionar la moda masculina' },
  ...
  constructor() {
    this.seo.update({
      title: 'Nuestra Historia · EMPRM',
      description:
        'La historia de EMPRM: más de dos décadas creando moda masculina premium. Conoce nuestra trayectoria, misión, visión y valores.',
    });
  }
}
