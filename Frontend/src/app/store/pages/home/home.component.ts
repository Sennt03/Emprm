...
export class HomeComponent {
  ...
  constructor() {
    this.seo.update({
      title: 'EMPRM · Elegancia y estilo para el hombre moderno',
      description:
        'EMPRM — moda masculina premium. Descubre colecciones exclusivas y las prendas más populares para el hombre moderno.',
    });
